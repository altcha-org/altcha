(function(factory) {
  ...
  const i18n$5 = {
    ...
    footer: 'Qorunur <a href="https://altcha.org/" tabindex="-1" target="_blank" rel="noopener" aria-label="Altcha (rəsmi vebsayt)">ALTCHA</a> tərəfindən',
  ...
  const i18n$3 = {
    ...
    footer: 'დაცულია <a href="https://altcha.org/" tabindex="-1" target="_blank" rel="noopener" aria-label="Altcha (ოფიციალური ვებსაიტი)">ALTCHA</a>-ით',
  ...
  const i18n$1 = {
    ...
    footer: 'Goralan <a href="https://altcha.org/" tabindex="-1" target="_blank" rel="noopener" aria-label="Altcha (resmi web sahypa)">ALTCHA</a> tarapyndan',
