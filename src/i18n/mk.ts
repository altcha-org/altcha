...
const i18n = {
	...
	enterCodeAria:
		'Внесете го кодот што го слушате. Притиснете Space за да ја пуштите аудио снимката.',
	error: 'Проверката не успеа. Обидете се подоцна.',
	expired: 'Проверката истече. Обидете се повторно.',
	footer:
		'Заштитено со <a href="https://altcha.org/" tabindex="-1" target="_blank" rel="noopener" aria-label="Altcha (официјален веб-сајт)">ALTCHA</a>',
