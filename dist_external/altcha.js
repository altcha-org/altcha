...
function Ra(e, t) {
  ...
  Tr(() => {
    ...
    var n;
    x("mounted", "2.0.5"), x("workers", at()), Xi(), x("plugins", Me.length ? Me.map((f) => f.constructor.pluginName).join(", ") : "none"), ve() && x("using test mode"), S() && br(S()), l() !== void 0 && x("auto", l()), E() !== void 0 && vn(E()), w(L, (n = a(re)) == null ? void 0 : n.closest("form"), !0), a(L) && (a(L).addEventListener("submit", on, { capture: !0 }), a(L).addEventListener("reset", an), (l() === "onfocus" || K() === "focus") && a(L).addEventListener("focusin", ln)), l() === "onload" && (Oe() ? It() : De()), a(vr) && (ee() || z()) && x("Attributes hidefooter and hidelogo ignored because usage with free API Keys requires attribution."), requestAnimationFrame(() => {
      Fe("load");
    });
  });
  function jt(n, f) {
