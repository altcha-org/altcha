...
const ke = 2, Ka = 4, nr = 8, zr = 16, Pe = 32, rt = 64, Qt = 128, he = 256, er = 512, ce = 1024, Se = 2048, at = 4096, mt = 8192, or = 16384, Hn = 32768, Nr = 65536, Fn = 1 << 19, Ja = 1 << 20, Tr = 1 << 21, jt = Symbol("$state"), Xa = Symbol("legacy props"), Mn = Symbol(""), Bn = typeof requestIdleCallback > "u" ? (e) => setTimeout(e, 1) : requestIdleCallback;
let Pt = [], zt = [];
function Qa() {
  var e = Pt;
  Pt = [], Wa(e);
  ...
  return i && r.set("length", /* @__PURE__ */ D(
    ...
    e,
    {
      defineProperty(s, f, d) {
        ...
        var p = r.get(f);
        return p === void 0 ? (p = u(() => /* @__PURE__ */ D(d.value)), r.set(f, p)) : y(
          p,
          u(() => Fe(d.value))
        ), !0;
      },
      ...
      get(s, f, d) {
        ...
        if (f === jt)
          return e;
        var p = r.get(f), h = f in s;
        if (p === void 0 && (!h || (k = Qe(s, f)) != null && k.writable) && (p = u(() => /* @__PURE__ */ D(Fe(h ? s[f] : ue))), r.set(f, p)), p !== void 0) {
          var v = l(p);
      ...
      has(s, f) {
        ...
        if (f === jt)
          return !0;
        var d = r.get(f), p = d !== void 0 && d.v !== ue || Reflect.has(s, f);
        if (d !== void 0 || $ !== null && (!p || (v = Qe(s, f)) != null && v.writable)) {
          d === void 0 && (d = u(() => /* @__PURE__ */ D(p ? Fe(s[f]) : ue)), r.set(f, d));
          var h = l(d);
          if (h === ue)
            return !1;
        }
      ...
      set(s, f, d, p) {
        ...
        h === void 0 ? (!v || (K = Qe(s, f)) != null && K.writable) && (h = u(() => /* @__PURE__ */ D(void 0)), y(
          h,
          u(() => Fe(d))
        ), r.set(f, h)) : (v = h.v !== ue, y(
          h,
          u(() => Fe(d))
        ));
        var _ = Reflect.getOwnPropertyDescriptor(s, f);
        if (_ != null && _.set && _.set.call(p, d), !v) {
          if (i && typeof f == "string") {
            ...
            Number.isInteger(fe) && fe >= q.v && y(q, fe + 1);
          }
          Lr(o);
        }
        return !0;
...
function fi(e) {
  var t = ci(e), r = (Me || (e.f & he) !== 0) && e.deps !== null ? at : ce;
...
function fo(e, t) {
  if (!e.equals(t)) {
    var r = e.v;
    Dt ? Nt.set(e, t) : Nt.set(e, r), e.v = t, (e.f & ke) !== 0 && ((e.f & Se) !== 0 && ci(
      /** @type {Derived} */
      e
    ), _e(e, (e.f & he) === 0 ? ce : at)), e.wv = yi(), hi(e, Se), $ !== null && ($.f & ce) !== 0 && ($.f & (Pe | rt)) === 0 && (ve === null ? vo([e]) : ve.push(e));
  }
  return t;
}
function hi(e, t) {
  ...
  if (r !== null)
    for (var i = r.length, o = 0; o < i; o++) {
      var n = r[o], u = n.f;
      (u & Se) === 0 && (_e(n, t), (u & (ce | he)) !== 0 && ((u & ke) !== 0 ? hi(
        /** @type {Derived} */
        n,
        at
      ) : fr(
...
function qt(e) {
  ...
  if ((t & at) !== 0) {
    ...
    if (r !== null) {
      var o, n, u = (t & er) !== 0, s = i && $ !== null && !Me, f = r.length;
      if (u || s) {
        var d = (
          /** @type {Derived} */
          e
  ...
  if (i !== null)
    for (var o = 0; o < i.length; o++) {
      ...
      ne != null && ne.includes(e) || ((n.f & ke) !== 0 ? Ai(
        ...
        t,
        !1
      ) : t === n && (r ? _e(n, Se) : (n.f & ce) !== 0 && _e(n, at), fr(
        /** @type {Effect} */
        n
      )));
    }
...
function ki(e) {
  var k;
  var t = ae, r = de, i = ve, o = j, n = Me, u = ne, s = ie, f = Te, d = e.f;
  ae = /** @type {null | Value[]} */
  ...
  try {
    ...
    ae = t, de = r, ve = i, j = o, Me = n, ne = u, $a(s), Te = f, e.f ^= Tr;
  }
}
function po(e, t) {
  let r = t.reactions;
...
function Ao(e) {
  for (var t = [], r = e; r !== null; ) {
    var i = r.f, o = (i & (Pe | rt)) !== 0, n = o && (i & ce) !== 0;
    if (!n && (i & mt) === 0) {
      if ((i & Ka) !== 0)
        t.push(r);
      else if (o)
...
function Ii(e, t) {
  if ((e.f & mt) !== 0) {
    e.f ^= mt, (e.f & ce) === 0 && (e.f ^= ce), qt(e) && (_e(e, Se), fr(e));
...
function Si(e, { target: t, anchor: r, props: i = {}, events: o, context: n, intro: u = !0 }) {
  ...
  var d = void 0, p = Lo(() => {
    ...
    return Rr(() => {
      ...
      $r.delete(f), h !== r && ((V = h.parentNode) == null || V.removeChild(h));
    };
  });
  return Sr.set(d, p), d;
}
...
function W(e, t, [r, i] = [0, 0]) {
  N && r === 0 && yt();
  var o = e, n = null, u = null, s = ue, f = r > 0 ? Nr : 0, d = !1;
  const p = (v, k = !0) => {
    d = !0, h(k, v);
  }, h = (v, k) => {
    if (s === (s = v)) return;
...
function Xe(e, t, r = !1, i = !1, o = !1) {
  ...
  xe(() => {
    ...
    if (s.nodes_start !== null && (Ei(
      ...
      if (N) {
        z.data;
        for (var f = yt(), d = f; f !== null && (f.nodeType !== 8 || /** @type {Comment} */
        f.data !== ""); )
...
function x(e, t, r, i) {
  var nt;
  var o = (r & ro) !== 0, n = !0, u = (r & io) !== 0, s = (r & no) !== 0, f = !1, d;
  u ? [d, f] = Go(() => (
    /** @type {V} */
    e[t]
  )) : d = /** @type {V} */
  ...
  if (h) {
    ...
    return function(H, oe) {
      return arguments.length > 0 ? ((!oe || fe || f) && h(oe ? q() : H), H) : q();
    };
  }
  ...
  constructor(t) {
    ...
    const o = new Proxy(
      { ...t.props || {}, $$events: {} },
      {
        ...
        set(u, s, f) {
          return y(r.get(s) ?? i(s, f), f), Reflect.set(u, s, f);
        }
      }
    );
...
globalThis.altchaI18n.set("et", fl);
const dl = {
...
const Jl = "5";
var Za;
typeof window < "u" && ((Za = window.__svelte ?? (window.__svelte = {})).v ?? (Za.v = /* @__PURE__ */ new Set())).add(Jl);
...
function ws(e, t) {
  ...
  }), gr = /* @__PURE__ */ It(() => f() ? ua(f()) : void 0), Zi = /* @__PURE__ */ It(() => ot() ? ua(ot()) : {}), P = /* @__PURE__ */ It(() => ({
    ...Xr(o()),
    ...l(Zi)
  ...
  Vr(() => {
    ...
    var a;
    I("mounted", "2.0.0-beta.12"), I("workers", lt()), Ji(), I("plugins", qe.length ? qe.map((c) => c.constructor.pluginName).join(", ") : "none"), ge() && I("using test mode"), V() && pr(V()), n() !== void 0 && I("auto", n()), _() !== void 0 && fa(_()), y(S, (a = l(re)) == null ? void 0 : a.closest("form"), !0), l(S) && (l(S).addEventListener("submit", ia, { capture: !0 }), l(S).addEventListener("reset", na), (n() === "onfocus" || K() === "focus") && l(S).addEventListener("focusin", aa)), n() === "onload" && (ze() ? Lt() : je()), l(hr) && (ee() || J()) && I("Attributes hidefooter and hidelogo ignored because usage with free API Keys requires attribution."), requestAnimationFrame(() => {
      Ne("load");
    });
  });
  function Ht(a, c) {
      ...
      return I("generating test challenge", { test: ge() }), Ql(typeof ge() != "boolean" ? +ge() : void 0);
    {
      ...
      if (m)
        try {
          ...
          L && typeof L == "object" && (L.verifyurl && !L.verifyurl.startsWith("javascript:") && (L.verifyurl = ea(L.verifyurl)), ga(L));
        } catch (L) {
  ...
  function Wi(a) {
    var g, m;
    const c = (g = l(S)) == null ? void 0 : g.querySelector(typeof a == "string" ? `input[name="${a}"]` : 'input[type="email"]:not([data-no-spamfilter])');
  ...
  function Xr(a, c = [
    ...
    const g = Object.keys(a).map((b) => b.toLowerCase()), m = c.reduce(
...
`) : A), m;
  ...
  function ea(a, c) {
    ...
    if (m.search || (m.search = g.search), c)
      for (const b in c)
        c[b] !== void 0 && c[b] !== null && m.searchParams.set(b, c[b]);
    return m.toString();
  }
  function Ji() {
    const a = Ot() !== void 0 ? Ot().split(",") : void 0;
    for (const c of globalThis.altchaPlugins)
      (!a || a.includes(c.pluginName)) && qe.push(new c({
        el: l(re),
        clarify: Lt,
        dispatch: Ne,
        getConfiguration: va,
  ...
  function I(...a) {
    (h() || a.some((c) => c instanceof Error)) && console[a[0] instanceof Error ? "error" : "log"]("ALTCHA", `[name=${oe()}]`, ...a);
  }
  function Xi() {
    y(B, Q.PAUSED, !0);
  }
  ...
  function nn(a) {
    ...
    if (a.preventDefault(), a.stopPropagation(), l(M)) {
      ...
      if ((c = te()) != null && c.startsWith("javascript:")) {
      ...
      y(Ke, !0), ca(Ht(l(M).challenge, l(M).solution), m).then(({ reason: b, verified: C }) => {
  ...
  function ta(a) {
    var g;
    const c = a.target;
    _() && c && !l(re).contains(c) && (l(T) === w.VERIFIED && K() === !1 || l(T) === w.VERIFIED && K() === "focus" && !((g = l(S)) != null && g.matches(":focus-within")) || n() === "off" && l(T) === w.UNVERIFIED) && ma();
  }
  function ra() {
  ...
  function on(a) {
    for (const c of qe)
      typeof c.onErrorChange == "function" && c.onErrorChange(l(We));
  }
  function aa(a) {
    l(T) === w.UNVERIFIED ? je() : _() && K() === "focus" && l(T) === w.VERIFIED && mr();
  }
  function ia(a) {
    const c = a.target, g = a.submitter;
    c != null && c.hasAttribute("data-code-challenge-form") || (l(S) && n() === "onsubmit" ? l(T) === w.UNVERIFIED ? (a.preventDefault(), a.stopPropagation(), je().then(() => {
      un(g);
  ...
  function ln(a) {
    for (const c of qe)
      typeof c.onStateChange == "function" && c.onStateChange(l(T));
  ...
  async function sn(a) {
    ...
    if (Ce() !== !1) {
      ...
      c.blockedCountries = b, c.classifier = C, c.disableRules = A, c.email = L === !1 ? void 0 : Wi(L), c.expectedCountries = X, c.expectedLanguages = F || (Yr ? [Yr] : void 0), c.fields = le === !1 ? void 0 : Qr(le), c.ipAddress = Oe === !1 ? void 0 : Oe || "auto", c.text = Ar, c.timeZone = Bt === !1 ? void 0 : Bt || Ua();
    }
    const g = await Jr()(te(), {
  ...
  async function ca(a, c) {
    if (!te())
      throw new Error("Attribute verifyurl not set.");
    I("requesting sentinel verification from", te());
    const g = { code: c, payload: a };
  ...
  function un(a) {
    var c;
    l(S) && "requestSubmit" in l(S) ? l(S).requestSubmit(a) : (c = l(S)) != null && c.reportValidity() && (a ? a.click() : l(S).submit());
  }
  function pr(a) {
  ...
  async function ha(a) {
    ...
    if ("Worker" in window) {
      try {
        c = await cn(a, a.maxNumber || a.maxnumber || me());
      } catch (g) {
        I(g);
      }
      if ((c == null ? void 0 : c.number) !== void 0 || "obfuscated" in a)
        return { data: a, solution: c };
    }
    if ("obfuscated" in a) {
  ...
  async function cn(a, c = typeof ge() == "number" ? ge() : a.maxNumber || a.maxnumber || me(), g = Math.ceil(lt())) {
    const m = [];
    g = Math.min(16, c, Math.max(1, g));
    for (let A = 0; A < g; A++)
      m.push(altchaCreateWorker(_t()));
    const b = Math.ceil(c / g), C = await Promise.all(m.map((A, L) => {
      const F = L * b;
  ...
  async function Lt() {
    ...
    const a = qe.find((c) => c.constructor.pluginName === "obfuscation");
    if (!a || !("clarify" in a)) {
  ...
  function ga(a) {
    a.obfuscated !== void 0 && ze(a.obfuscated), a.auto !== void 0 && (n(a.auto), n() === "onload" && (ze() ? Lt() : je())), a.blockspam !== void 0 && u(!!a.blockspam), a.customfetch !== void 0 && p(a.customfetch), a.floatinganchor !== void 0 && q(a.floatinganchor), a.delay !== void 0 && v(a.delay), a.floatingoffset !== void 0 && fe(a.floatingoffset), a.floating !== void 0 && fa(a.floating), a.expire !== void 0 && (pr(a.expire), V(a.expire)), a.challenge && (f(typeof a.challenge == "string" ? a.challenge : JSON.stringify(a.challenge)), da(l(gr))), a.challengeurl !== void 0 && s(a.challengeurl), a.debug !== void 0 && h(!!a.debug), a.hidefooter !== void 0 && ee(!!a.hidefooter), a.hidelogo !== void 0 && J(!!a.hidelogo), a.language !== void 0 && ot(Xr(o(), [a.language])), a.maxnumber !== void 0 && me(+a.maxnumber), a.mockerror !== void 0 && At(!!a.mockerror), a.name !== void 0 && oe(a.name), a.refetchonexpire !== void 0 && kt(!!a.refetchonexpire), a.sentinel !== void 0 && typeof a.sentinel == "object" && Ye(a.sentinel), a.spamfilter !== void 0 && Ce(typeof a.spamfilter == "object" ? a.spamfilter : !!a.spamfilter), a.strings && ot(typeof a.strings == "string" ? a.strings : JSON.stringify(a.strings)), a.test !== void 0 && ge(typeof a.test == "number" ? a.test : !!a.test), a.verifyurl !== void 0 && te(a.verifyurl), a.workers !== void 0 && lt(+a.workers), a.workerurl !== void 0 && _t(a.workerurl);
  }
  function va() {
    return {
      auto: n(),
  ...
  function fn(a) {
    return qe.find((c) => c.constructor.pluginName === a);
  }
  function pa() {
    return l(T);
  }
  ...
  function Et(a = 20) {
    var c;
    if (l(re))
      if (l(st) || y(st, (q() ? document.querySelector(q()) : (c = l(S)) == null ? void 0 : c.querySelector('input[type="submit"], button[type="submit"], button:not([type="button"]):not([type="reset"])')) || l(S), !0), l(st)) {
        const g = parseInt(fe(), 10) || 12, m = l(st).getBoundingClientRect(), b = l(re).getBoundingClientRect(), C = document.documentElement.clientHeight, A = document.documentElement.clientWidth, L = _() === "auto" ? m.bottom + b.height + g + a > C : _() === "top", F = Math.max(a, Math.min(A - a - b.width, m.left + m.width / 2 - b.width / 2));
  ...
  function ut(a = w.UNVERIFIED, c = null) {
    Le && (clearTimeout(Le), Le = null), y(wt, !1), y(Re, null), y(M, null), y(br, !1), y(B, null), Ee(a, c);
  }
  function ya(a) {
    y(st, a, !0);
  }
  function Ee(a, c = null) {
    y(T, a, !0), y(We, c, !0), Ne("statechange", {
      payload: l(Re),
      state: l(T)
    });
  }
  ...
  async function je() {
    return ut(w.VERIFYING), await new Promise((a) => setTimeout(a, v() || 0)), Yi().then((a) => (da(a), I("challenge", a), ha(a))).then(({ data: a, solution: c }) => {
      var g;
      if (I("solution", c), !c || a && "challenge" in a && !("clearText" in c))
        if ((c == null ? void 0 : c.number) !== void 0 && "challenge" in a)
          if (te() && "codeChallenge" in a)
            ((g = document.activeElement) == null ? void 0 : g.tagName) === "INPUT" && k() === !1 && document.activeElement.blur(), y(M, { challenge: a, solution: c }, !0);
          else {
            if (te() && Ye() !== void 0)
              return ca(Ht(a, c));
            if (te())
              return sn(Ht(a, c));
            y(Re, Ht(a, c), !0), I("payload", l(Re));
          }
        else
  ...
  var La = Y(Ca, 2);
  {
    var pn = (a) => {
      var c = cs(), g = G(c);
      R(g, "href", Ui), Z(c), xe(() => R(g, "aria-label", l(P).ariaLinkLabel)), O(a, c);
    };
    W(La, (a) => {
      (J() !== !0 || l(hr)) && a(pn);
    });
  ...
  {
    var yn = (a) => {
      var c = bs(), g = Y(G(c), 2), m = G(g), b = Y(m, 2);
      Vo(b, !k()), b.__keydown = [
        ns,
        la
      ];
      ...
      Z(g), Z(c), xe(() => {
        R(c, "aria-label", l(P).verificationRequired), R(m, "src", l(M).challenge.codeChallenge.image), R(b, "minlength", l(M).challenge.codeChallenge.length || 1), R(b, "maxlength", l(M).challenge.codeChallenge.length), R(b, "placeholder", l(P).enterCode), R(b, "aria-label", l(B) === Q.LOADING ? l(P).loading : l(B) === Q.PLAYING ? "" : l(P).enterCodeAria), R(b, "aria-live", l(B) ? "assertive" : "polite"), R(b, "aria-busy", l(B) === Q.LOADING), b.disabled = l(Ke), R(X, "aria-label", l(P).reload), R(X, "title", l(P).reload), X.disabled = l(Ke), le.disabled = l(Ke), R(le, "aria-label", l(P).verify), So(Bt, ` ${l(P).verify ?? ""}`);
      }), He("submit", g, nn, !0), O(a, c);
    };
    W(mn, (a) => {
      var c;
      (c = l(M)) != null && c.challenge.codeChallenge && a(yn);
    });
  }
  Z(yr);
  var Ea = Y(yr, 2);
  ...
  {
    var kn = (a) => {
      var c = As(), g = G(c), m = G(g);
      Xe(m, () => l(P).footer), Z(g), Z(c), O(a, c);
    };
    W(xa, (a) => {
