...
function Sa(e, t) {
  ...
  Or(() => {
    ...
    var n;
    x("mounted", "2.0.3"), x("workers", ft()), rl(), x("plugins", Ue.length ? Ue.map((f) => f.constructor.pluginName).join(", ") : "none"), ge() && x("using test mode"), S() && Cr(S()), l() !== void 0 && x("auto", l()), C() !== void 0 && bn(C()), p(L, (n = a(q)) == null ? void 0 : n.closest("form"), !0), a(L) && (a(L).addEventListener("submit", cn, { capture: !0 }), a(L).addEventListener("reset", dn), (l() === "onfocus" || z() === "focus") && a(L).addEventListener("focusin", fn)), Ie() && yn(!0), l() === "onload" && (Ve() ? St() : Pe()), a(br) && (te() || X()) && x("Attributes hidefooter and hidelogo ignored because usage with free API Keys requires attribution."), requestAnimationFrame(() => {
      Me("load");
    });
  });
  function Yt(n, f) {
